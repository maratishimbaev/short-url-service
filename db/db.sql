...
CREATE TABLE public.url (
    id integer NOT NULL,
    old_url character varying(128) NOT NULL,
    new_url character varying(128) NOT NULL
);
...
--
-- Name: url url_new_url_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.url
    ADD CONSTRAINT url_new_url_key UNIQUE (new_url);
